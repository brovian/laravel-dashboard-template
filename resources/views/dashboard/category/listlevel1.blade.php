...
Zepto(function($){
	$('.parentbutton').on('click',function(){
		window.location.href="/dashboard/category/list/depth/0/parentid/0"
	})
})
</script>
</head>
        ...
        <div class="col c10 contentpage">
			...
			<div class="row">
				<div class="col c5 rounded addform">
				    ...
				    <?php endif;?>
				    <form action="/dashboard/category/add/depth/1/parentid/{{$parentid}}" method="post">
				    {!! csrf_field() !!}
				    <div class="row">
				    	<div class="col c2">
				    		<div>父分类</div>
				...
				<div class="col c11 rounded">
				    ...
				    <table class="datatable">
				    	...
				    	<tr>
				    		...
				    		<td>
				    			<a href="/dashboard/category/edit/depth/1/id/{{$row['id']}}" class="btn btn-a btn-sm">编辑</a>
				    			<a href="/dashboard/category/list/depth/{{$depth+1}}/parentid/{{$row['id']}}" class="btn btn-b btn-sm">子分类</a>
				    		</td>
				    	</tr>
				    	<?php endforeach;?>
				    </table>
